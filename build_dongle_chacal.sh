...
./bootstrap
make -f examples/Makefile-nrf52840 DISABLE_BUILTIN_MBEDTLS=1 EXTERNAL_HEAP=1 BORDER_ROUTER=1 COAP=1 COMMISSIONER=1 DNS_CLIENT=1 JOINER=1 MAC_FILTER=1 MTD_NETDIAG=1 SERVICE=1 UDP_PROXY=1 BORDER_AGENT=1 USB=1 BOOTLOADER=1
